...
from pointpillars_ros.drone_pointpillars.model.anchors import Anchors, anchor_target, anchors2bboxes
from pointpillars_ros.drone_pointpillars.ops import Voxelization, nms_cuda
from pointpillars_ros.drone_pointpillars.utils import limit_period
...
class PointPillars(nn.Module):
    def __init__(self,
                 ...
                 point_cloud_range=[0, -39.68, -40, 69.12, 39.68, 40], # min x, min y, min z, max x, max y, max z
                 max_num_points=32,
