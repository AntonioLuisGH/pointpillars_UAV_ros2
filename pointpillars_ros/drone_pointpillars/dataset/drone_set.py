...
from pointpillars_ros.drone_pointpillars.utils import read_pickle, read_points, bbox_camera2lidar
from pointpillars_ros.drone_pointpillars.dataset import point_range_filter, data_augment
...
class DroneDataset(Dataset):
    ...
    def __init__(self, data_root, split):
        ...
        self.data_aug_config=dict(
            ...
            point_range_filter=[0, -39.68, -40, 69.12, 39.68, 40],
            object_range_filter=[0, -39.68, -40, 69.12, 39.68, 40]             
        )
    ...
    def __getitem__(self, index):
        ...
        # ---------- We do not use camera in our setup, so idendety rectification — however we do rotate the axis of the GT bouding boxes (Ive hardcoded it since we use the same for each frame) ----------
